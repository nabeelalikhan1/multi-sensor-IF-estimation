...
w=exp(-abs(n-64)/64);
s1=w.*exp(2*pi*1i*(0.05*n+0.2*n.^3/(128*128*3)));
s2=w.*exp(2*pi*1i*(0.4*n-0*0.3*n.^3/(128*128*3)));
s3=w.*exp(2*pi*1i*(0.1*n-0*0.45*n.^3/(128*128*3)));
s4=w.*exp(2*pi*1i*(0.475*n-0.2*n.^3/(128*128*3)));
%s5=1*exp(2*pi*1i*(0.35*n-1*n.^2/(128*8)));
%s6=1*exp(2*pi*1i*(0.25*n+0.5*n.^2/(128*8)));
s5=w.*exp(2*pi*1i*(0.25*n+0*0.5*n.^2/(128*8)));
